...
class TikTokService {
  ...
  constructor(advertiserId?: string) {
    this.advertiserId = advertiserId || env.TIKTOK_ADVERTISER_ID;
  ...
  /**
   * Create a new TikTokService instance with a specific advertiser account
   */
  static withAccount(advertiserId: string): TikTokService {
    return new TikTokService(advertiserId);
  }
