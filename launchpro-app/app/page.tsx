        ...
        <div className="bg-white rounded-xl shadow-lg p-12">
          ...
          <div className="grid md:grid-cols-5 gap-4 items-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Choose from Tonic offers</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Copy, images, videos</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Deploy to platforms</p>
            </div>
          </div>
        </div>
