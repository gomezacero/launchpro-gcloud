...
const DEPLOYMENT_VERSION = 'v2.9.1-ANTHROPIC-COMPLETELY-REMOVED';
const DEPLOYMENT_TIMESTAMP = '2026-01-26T21:00:00Z';
...
export async function GET() {
  return NextResponse.json({
    ...
    message: 'If you see this, the deployment is running v2.9.1 code with NO Anthropic SDK',
  });
}
